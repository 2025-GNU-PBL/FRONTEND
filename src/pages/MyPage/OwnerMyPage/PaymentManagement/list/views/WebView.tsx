...
export default function WebView() {
  ...
  return (
    <main className="min-h-screen w-full bg-[#F6F7FB] text-gray-900 flex flex-col mt-10">
      <div className="pt-16 pb-16">
        <div className="max-w-[960px] mx-auto px-6 space-y-8">
          ...
          {/* owner 여부에 따라 본문 분기 (훅은 이미 위에서 모두 호출됨) */}
          {!owner ? (
            <SectionCard
              title="접근 불가"
