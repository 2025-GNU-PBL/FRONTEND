...
const RegisterWebView = () => {
  ...
  const handleSubmit = async () => {
    ...
    const couponData = {
      ...
      category: selectedCategory ?? ("DRESS" as ProductCategory), // selectedCategory 사용
      startDate,
      expirationDate,
    };
  ...
  return (
    <div className="flex flex-col items-center min-h-screen bg-gray-100 p-4 pt-20"> {/* pt-20 추가: Navbar 높이만큼 상단 패딩 */}
      {/* Page Title */}
      <div className="w-full max-w-4xl h-auto py-4 bg-white flex flex-row justify-between items-center px-6 shadow-sm mb-6 rounded-lg"> {/* sticky top-0 z-10 클래스 제거 */}
        <button
        ...
        <div className="font-['Pretendard'] font-semibold text-2xl leading-[160%] text-center tracking-[-0.2px] text-black">
          쿠폰 등록
        </div>
        <button
          className="h-9 px-4 py-2 bg-[#FF2233] text-white rounded-md text-sm font-semibold flex items-center justify-center"
          onClick={handleSubmit}
          aria-label="register-coupon"
        >
          등록하기
        </button>
      </div>
      ...
      {/* Form Content */}
      <div className="w-full max-w-4xl bg-white p-8 rounded-lg shadow-lg flex flex-col items-start gap-[20px]"> {/* pt-[80px] 클래스 제거 */}
        {/* Coupon Code */}
        ...
        {/* Product Selection */}
        <div className="flex flex-col items-start gap-[10px] w-full relative" ref={dropdownRef}>
          <div className="w-full h-[21px] font-['Pretendard'] font-normal text-sm leading-[150%] tracking-[-0.2px] text-black">
            상품 선택
          </div>
          <button
        ...
        <div className="w-full relative mt-[10px]">
          ...
          <div className="flex flex-row justify-between w-full gap-4 h-[49px] mt-[10px]">
            <div className="box-border flex flex-col justify-center items-center p-0 flex-1 h-[49px] rounded-[10px] cursor-pointer"
        ...
        <div className="w-full relative mt-[10px]">
          ...
          <div className="flex flex-row justify-between w-full gap-4 h-[49px] mt-[10px]">
            <div className="box-border relative flex flex-row items-center justify-between p-0 flex-1 h-[49px] border border-[#E8E8E8] rounded-[10px]">
              <input
                type="date"
      ...
      {/* Submit Button for Web */}
      <div className="w-full max-w-4xl mt-6 px-[20px] py-[20px] flex justify-center">
        <button
          className="flex flex-col justify-center items-center p-[16px] w-full h-[56px] bg-[#FF2233] rounded-[12px] mx-auto"
          onClick={handleSubmit}
        >
